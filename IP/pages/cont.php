...
<body>
    ...
    <main>
        ...
        <div class="center">
            <div class = "contacts">
                Мой мобильный номер - 89061471678  
                Почта - vovafaceit3@mail.ru
            </div>
            <a class = "button" target="blank" href = "https://www.instagram.com/31iwnl//">Мой Инстаграм</a>
            <a class = "button" target="blank" href = "https://vk.com/godzilla_99">Мой Вконтакте</a>
            <a class = "button" target="blank" href = "https://github.com/31iwnl">Мой GitHub</a>
